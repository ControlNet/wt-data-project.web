...
import { ref } from 'vue'
import { heatMapState } from "@/stores/heatMapState"
...
heatMapState.dispatch("getCsvDataBySelected")

</script>


<template>
    <div class="flex heatmap-contian">
        <div class="flex" id="heat-mapx">
            <div class="flex br-heatmap-y" id="br-heatmap-y">
            </div>
            <div id="heat-map">
