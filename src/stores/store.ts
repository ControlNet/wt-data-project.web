...
import type { HeatMapState,OnSomeSelectChange,TimeseriesABRow } from "@/config/types"


export const key: InjectionKey<Store<HeatMapState>> = Symbol()

export const heatMapDataStore = createStore<HeatMapState>({
  state () {
    return {
      metaData:[],
      selectedDate:'',
